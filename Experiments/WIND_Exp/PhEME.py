...
def obtain_BiGCN(pretrained_vectorizer, device=None):
    ...
    BiGCN_model = MME_BiGCN(lvec, prop, cls)
    return BiGCN_model
...
if __name__ == '__main__':
    ...
    trainer = MMETrainer(seed=10086, log_dir=log_dir, suffix=f"{test_event_name}_FS{fewShotCnt}",
                            model_file=f"./MME_{test_event_name}_FS{fewShotCnt}.pkl",
